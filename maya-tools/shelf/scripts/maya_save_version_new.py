...
import maya_checkout_new as maya_checkout # This isn't used... probably because the checkout module needs context, and this doesn't have it.
import maya_checkin_new as maya_checkin
